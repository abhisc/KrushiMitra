...
import { 
  ...
  Users, BarChart3, Menu, Settings, ChevronDown, Bot, ArrowLeft
} from 'lucide-react';
...
export default function AppLayout({ children, showBackButton = false, title, subtitle }: AppLayoutProps) {
  ...
  const quickLinks = [
    ...
    { icon: Activity, label: 'Diagnose', href: '/diagnose', active: pathname === '/diagnose' },
    { icon: TrendingUp, label: 'Market', href: '/market', active: pathname === '/market' },
    { icon: FileText, label: 'Schemes', href: '/schemes', active: pathname === '/schemes' },
    { icon: Cloud, label: 'Weather', href: '/weather', active: pathname === '/weather' },
    { icon: Calendar, label: 'History', href: '/history', active: pathname === '/history' }
  ];
